-- ========================================
-- RESET REVIEW NOTIFICATION ON REGENERATE
-- ========================================
-- When reviewer requests edit/regenerate, clear notified_at so the worker
-- sends a fresh Slack approval message for the new draft.
-- ========================================
