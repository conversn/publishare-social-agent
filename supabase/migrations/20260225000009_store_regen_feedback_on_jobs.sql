-- ========================================
-- STORE REGEN FEEDBACK ON JOB PAYLOAD
-- ========================================
-- Updates request_edit_content_job to persist reviewer feedback into:
-- - payload.review_feedback (append-only array)
-- - payload.context (augmented text for next generation attempt)
-- ========================================
